...
export const createProposalColumns = (
    ...
    {
		accessorKey: "int rate",
		header: "Int Rate",
	},
    {
		accessorKey: "term month",
		header: "Term(Month)",
	},
    {
		accessorKey: "Amount",
...
export const columns: ColumnDef<FixedDepositList>[] = createProposalColumns(0, 25);
