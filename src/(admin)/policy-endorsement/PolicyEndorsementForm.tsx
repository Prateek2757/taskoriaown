...
import InsuredBuildDetails from "./components/policyTab/InsuredBuildsDetails";
...
import ChildDetails from "./components/policyTab/ChildDetails";

import BasicDetails from "./components/policyTab/BasicDetails";
import RiderList from "../premium-calculator/components/RiderList";
import ExtraDiscounts from "./components/policyTab/ExtraDiscounts";
import ProposerBasicDetails from "./components/policyTab/ProposerBasicsDetails";
import ProposerBuildDetails from "./components/policyTab/ProposerBuildsDetails";
import ProposerMedicalDetails from "./components/policyTab/ProposerMedicalDetails";
import ProposerLabTestDetails from "./components/policyTab/ProposalLabTestDetails";
import ProposerDoctorDetails from "./components/policyTab/ProposerDoctorsDetails";
import ProposerConstultantDoctorDetails from "./components/policyTab/ProposerConsultantsDoctotsDetails";


export default function PolicyEndorsementForm({ data }) {
