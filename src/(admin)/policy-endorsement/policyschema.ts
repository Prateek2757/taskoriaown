...
export const NomineeSchema = z.object({
    ...
    addressLocal: z.string().optional().nullable(),
    fatherName: z.string().optional().nullable(),
    fatherNameLocal: z.string().optional().nullable(),
...
export const EndorsementRequestSchema = z.object(
    {
        ...
        endorsementType:z.string().optional().nullable(),
        name:z.string().optional().nullable(),
        mobileNo:z.string().optional().nullable(),
        email:z.string().optional().nullable(),
        remarks:z.string().optional().nullable(),
        EndorsementrequestDocument:z.array(DocumentSchema).optional().nullable()

    }
)
export type EndorsementRequestDTO = z.infer<typeof EndorsementRequestSchema>;

export const emptyEndorsementRequest: EndorsementRequestDTO = {
    policyNo:"",
    endorsementType:"",
    name:"",
    mobileNo:"",
