			...
			<div className="border-0 md:border border-dashed border-gray-400 rounded-lg  p-0 md:p-6 md:pb-0">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
					...
					<div className="space-y-2">
						<FormInputNepali
							form={form}
							name="permanentStreetNameLocal"
							type="text"
							placeholder="Enter permanent street name in Nepali"
							label="Permanent Street Name (Nepali)"
						/>
					</div>
					...
					<div className="space-y-2">
						<FormInput
							...
							type="text"
							placeholder="Enter permanent house number"
				...
				<div className="border-0 md:border border-dashed border-gray-400 rounded-lg  p-0 md:p-6 md:pb-0">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
						...
						<div className="space-y-2">
							<FormInputNepali
								form={form}
								name="temporaryStreetNameLocal"
								type="text"
								placeholder="Enter temporary street name in Nepali"
								label="Temporary Street Name (Nepali)"
							/>
						</div>
						...
						<div className="space-y-2">
							<FormInput
								...
								type="text"
								placeholder="Enter temporary house number"
								label="Temporary House No."
								onKeyDown={onlyNumbers}
							/>
						</div>
