      ...
      {(branch.status !== "VERIFIED" || username === "Pradip Gautam") && (
        <>
          <Button
            variant="outline"
            size="icon"
            onClick={() => router.push(`/configuration/organization-setup/branch/branch/edit/${branch.rowId}`)}
            title="Edit"
          >
            <Pencil />
          </Button>
          <Button
            variant="outline"
            size="icon"
            onClick={() =>router.push(`/corporate-branch/sub-branch/${branch.branchCode}`)} 
            title="Get Sub-Branch List"
          >
            <Menu />
          </Button>
        </>
