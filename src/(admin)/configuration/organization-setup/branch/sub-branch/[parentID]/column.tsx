      ...
      {(branch.status !== "VERIFIED" || username === "Pradip Gautam") && (
        <>
          <Button
            variant="outline"
            size="icon"
            onClick={() => router.push(`/configuration/organization-setup/branch/sub-branch/edit/${branch.rowId}`)}
            title="Edit"
          >
            <Pencil />
          </Button>
          <Button
            variant="outline"
            size="icon"
            onClick={() =>router.push(`/configuration/organization-setup/branch/unit/${branch.branchCode}`)} 
            title="Get Unit List"
          >
            <Menu />
          </Button>
