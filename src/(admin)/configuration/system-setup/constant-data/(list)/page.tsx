...
import { createconstantDataValueColumns } from "./column";

export default function Page() {
  const searchOptions = [
    {
      placeholder: "Filter Data Name",
      name: "roleName",
      type: "text",
    },
  ];
  ...
  return (
    <div className="">
      <div className="relative md:fixed md:top-3 md:right-3 md:z-50 flex flex-wrap gap-2 mt-3 md:mt-0">
        <Button asChild>
          <Link
            href="/configuration/system-setup/constant-data/add"
      ...
      <DataTable
        ...
        columns={createconstantDataValueColumns}
        endpoint="kyc_list"
      />
    </div>
  );
