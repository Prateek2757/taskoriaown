...
// import type { AddEditKycDTO } from '../../schemas/kycSchema';

export default function Page() {
    const [kycData, setKycData] = useState<AddEditConstantDataValueDTO>();
    ...
    return <ConstantDataValueForm  data={kycData} />;
}
