...
export const ProductRateExcelForm = ({
	data,
						...
						<div className="p-6">
							...
							<div className="border-0 md:border border-dashed border-gray-400 rounded-lg  p-0 md:p-6 md:pb-0">
								<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
									...
									<FormInputFile
										name="productRateFile"
										label="Product Rate"
										form={form}
										fileNameField="productRateFileName"
										...
										{...(data?.productRateFile && {
											editMode: true,
											initialImageUrl: `${data.productRateFile[0]?.productRateFile}`,
											initialFileName: `${data.productRateFile[0]?.productRateFileName}`,
										})}
										required={true}
									/>
