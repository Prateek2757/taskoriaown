...
import { RiderDTO } from "@/app/(admin)/premium-calculator/premiumSchema";
import { AddProposalDTO, AddProposalSchema, emptyProposal } from "../../EndorsementSchema";
import KYCDetails from "@/app/(admin)/agent-training/components/kycDetails";
import PremiumForm from "@/app/(admin)/premium-calculator/components/PremiumForm";
import ChildDetails from "./ChildDetails";
import OccupationDetails from "@/app/(admin)/proposal/components/OccupationDetails";
import BasicDetails from "./BasicDetails";
import RiderList from "@/app/(admin)/premium-calculator/components/RiderList";
import AssumedTarget from "@/app/(admin)/proposal/components/AssumedTarget";
import ExtraDiscounts from "./ExtraDiscounts";
import InsuredBuildDetails from "./InsuredBuildsDetails";
import InsuredMedicalDetails from "@/app/(admin)/proposal/components/InsuredMedicalDetails";
import InsuredLabTestDetails from "@/app/(admin)/proposal/components/InsuredLabTestDetails";
import InsuredDoctorDetails from "@/app/(admin)/proposal/components/InsuredDoctorDetails";
import InsuredConstultantDoctorDetails from "@/app/(admin)/proposal/components/InsuredConstultantDoctorDetails";
import ProposerBasicDetails from "./ProposerBasicsDetails";
import ProposerBuildDetails from "./ProposerBuildsDetails";
import ProposerMedicalDetails from "./ProposerMedicalDetails";
import ProposerLabTestDetails from "./ProposalLabTestDetails";
import ProposerDoctorDetails from "./ProposerDoctorsDetails";
import ProposerConstultantDoctorDetails from "./ProposerConsultantsDoctotsDetails";
import NomineeDetail from "@/app/(admin)/proposal/components/NomineeDetails";
