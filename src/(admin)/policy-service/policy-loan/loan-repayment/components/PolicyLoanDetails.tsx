...
export const PolicyLoanDetails = ({ policyDetails }: PolicyDetailsProps) => {
        ...
        return (
            <div className="bg-white rounded-lg border-1 mb-6 mt-4 p-6 ">
                <h2 className="text-xl font-bold mb-3">Policy Loan Details</h2>
...
export default PolicyLoanDetails;
