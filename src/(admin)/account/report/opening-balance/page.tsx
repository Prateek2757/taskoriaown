        ...
        <table className="w-full">
          <thead>
            <tr className="bg-blue-400">
              ...
              <th className="border border-gray-300 px-4 py-3 text-center font-bold text-black" colSpan={5} rowSpan={2}>
                Ledger Name
              </th>
              <th className="border border-gray-300 px-4 py-3 text-center font-bold text-black" colSpan={2}>
                Opeaning Balance
              </th>
              <th className="border border-gray-300 px-4 py-3 text-center font-bold text-black" colSpan={2}>
                TurnOver Amount
          ...
          <tbody>
            <tr className="bg-white">
              ...
              <td className="border border-gray-300 px-4 py-3 text-center text-black" colSpan={5}>
                00
              </td>
