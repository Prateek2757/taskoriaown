...
export default function TrialBalance() {
  ...
  const toggleExpansion = (id: unknown) => {
    ...
    if (newExpanded.has(id)) {
      ...
      const item = findItemById(trialBalanceData, id);
  ...
  const findItemById = (
    items: any[],
    id: unknown
  ): typeof trialBalanceData[number] | null => {
            ...
            <table className="w-full">
              <thead className="bg-slate-600 text-white">
                <tr>
                  ...
                  <th
                    colSpan={2}
                    className="px-4 py-2 text-center text-sm font-medium border border-slate-500"
                  >
                    <div>OPENING</div>
                    <div className="grid grid-cols-2 border-t border-slate-500 mt-1">
                      <div className="text-center border-r border-slate-500 py-1">
                        Dr Amount
                      </div>
                      <div className="text-center py-1">Cr Amount</div>
                    </div>
                  </th>
              ...
              <tbody className="bg-white">
                {trialBalanceData.map((item) => renderRow(item))}
