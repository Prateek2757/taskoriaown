...
type ActionCellProps = { row: Row<DeathClaimType> };
...
// All List
export const deathAllColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<DeathClaimType>[] => [
  {
    accessorKey: "sn",
    header: "SN",
...
// Pending List
export const deathPendingColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<DeathClaimType>[] => [
  {
...
// Recommended List
export const deathRecommendedColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<DeathClaimType>[] => [
  {
  ...
  { accessorKey: "intimationDate", header: "Intimation Date" },
  { accessorKey: "claimStatus", header: "Status" },
  { accessorKey: "recommendedBy", header: "Recommend By" },
  { accessorKey: "recommendedDate", header: "Recommend Date" },
  {
    id: "actions",
    header: "Action",
    cell: ({ row }) => <ActionsCell row={row} />,
...
// Payment
export const deathPaymentColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<DeathClaimType>[] => [
  {
