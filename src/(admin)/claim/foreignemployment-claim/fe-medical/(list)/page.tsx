...
import {
  feMedicalAllColumns,
  feMedicalPendingColumns,
  feMedicalRecommendedColumns,
  feMedicalApprovedColumns,
} from "./columns";

export default function FeMedicalListPage() {
  return (
    <div>
      <Tabs defaultValue="all">
        ...
        <div className="relative md:absolute md:top-3 md:right-3 md:z-50 flex items-center gap-4">
          ...
          <Button asChild>
            <Link
              href="/claim/fe-claim/fe-medical/add"
        ...
        <TabsContent value="all">
          <DataTable
            ...
            columns={feMedicalAllColumns}
            endpoint="fe_medical_all_list"
          />
        </TabsContent>
        ...
        <TabsContent value="pending">
          <DataTable
            ...
            columns={feMedicalPendingColumns}
            endpoint="fe_medical_pending_list"
          />
        </TabsContent>
        ...
        <TabsContent value="recommended">
          <DataTable
            ...
            columns={feMedicalRecommendedColumns}
            endpoint="fe_medical_recommended_list"
          />
        </TabsContent>
        ...
        <TabsContent value="approved">
          <DataTable
            ...
            columns={feMedicalApprovedColumns}
            endpoint="fe_medical_approved_list"
          />
        </TabsContent>
      </Tabs>
    </div>
