...
// All List
export const feDeathAllColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDeathClaimType>[] => [
  {
    accessorKey: "sn",
    header: "SN",
...
// Pending List
export const feDeathPendingColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDeathClaimType>[] => [
  {
...
// Recommended List
export const feDeathRecommendedColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDeathClaimType>[] => [
  {
...
// Approved List
export const feDeathApprovedColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDeathClaimType>[] => [
  {
