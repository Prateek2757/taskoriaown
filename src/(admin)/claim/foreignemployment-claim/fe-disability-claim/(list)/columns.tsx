...
export type FeDisabilityClaimType = {
  rowId: number;
  sn: number;
  branch?: string;
  claimNo?: string;
...
// All List
export const feDisabilityAllColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDisabilityClaimType>[] => [
  {
    accessorKey: "sn",
    header: "SN",
...
// Pending List
export const feDisabilityPendingColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDisabilityClaimType>[] => [
  {
...
// Recommended List
export const feDisabilityRecommendedColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDisabilityClaimType>[] => [
  {
...
// Payment List
export const feDisabilityPaymentColumns = (
  pageIndex: number,
  pageSize: number
): ColumnDef<FeDisabilityClaimType>[] => [
  {
