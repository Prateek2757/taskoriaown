...
import { maturityAllColumns, maturityPaymentColumns } from "./columns";
        ...
        <TabsContent value="all">
          ...
          >
            <DataTable
              ...
              columns={maturityAllColumns}
              endpoint="maturity_all_list"
            />
          </div>
        </TabsContent>
        ...
        <TabsContent value="payment">
          ...
          >
            <DataTable
              ...
              columns={maturityPaymentColumns}
              endpoint="maturity_payment_list"
            />
          </div>
        </TabsContent>
      </Tabs>
