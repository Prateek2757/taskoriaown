...
import { createAgentPositionColumns } from "./columns";

export default function Page() {
  const searchOptions = [
    {
      placeholder: "Filter by Agent Code",
      name: "agentCode",
      type: "text",
    },
    {
      placeholder: "Filter by Qualified For",
      name: "qualifiedFor",
      type: "text",
    },
    {
  ...
  return (
    <div className="">
      <div className="relative md:fixed md:top-3 md:right-3 md:z-50 flex flex-wrap gap-2 mt-3 md:mt-0">
        <Button asChild>
          <Link
            href="/agency/hierarchy/agent-position/add"
          ...
          >
            ...
            <span>Add Agent Position</span>
          </Link>
        </Button>
      </div>
      <DataTable
        searchOptions={searchOptions}
        columns={createAgentPositionColumns}
        endpoint="agent_position_list"
      />
    </div>
  );
}
