    ...
    <div className="">
     <div className="relative md:fixed md:top-3 md:right-3 md:z-50 flex flex-wrap gap-2 mt-3 md:mt-0">
        ...
        <Button asChild>
          ...
          >
            <Plus color="#fff" size={18} />
            <span>Schema Set Up</span>
          </Link>
        </Button>

        <Button
          className="flex items-center gap-2 bg-orange-100 border border-orange-500 text-orange-600 hover:bg-orange-200"
        >
          <FileText size={18} />
          <span>Export</span>
        </Button>
        ...
        <Button
          className="flex items-center gap-2 bg-blue-100 border border-blue-500 text-blue-600 hover:bg-blue-200"
        >
          <FileDown size={18} />
          <span>PDF</span>
        </Button>
