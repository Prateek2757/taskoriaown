...
import {
  ...
  AgentPositionDTO,
  emptyAgentPosition,
} from "../schemas/agentPositionSchema";
        ...
        <div className="p-6">
          <Card className=" rounded-lg">
            <CardContent className="px-4 space-y-5">
              ...
              <div className="border border-dashed border-gray-300 rounded-md px-6 py-4 text-sm">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select
                        ...
                        value={field.value}
                      >
                        <SelectTrigger className="bg-gray-50 border border-gray-200 text-sm">
