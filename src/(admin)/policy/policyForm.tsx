...
import AssumedTarget from "../proposal/components/AssumedTarget";
import Documents from "../proposal/components/Documents";
// import GeneralDetails from "./policyTab/childDetails";
import InsuredBuildDetails from "../proposal/components/InsuredBuildDetails";
import InsuredConstultantDoctorDetails from "../proposal/components/InsuredConstultantDoctorDetails";
import InsuredDoctorDetails from "../proposal/components/InsuredDoctorDetails";
import InsuredLabTestDetails from "../proposal/components/InsuredLabTestDetails";
import InsuredMedicalDetails from "../proposal/components/InsuredMedicalDetails";
import KYCDetails from "../proposal/components/KYCDetails";
import NomineeDetail from "../proposal/components/NomineeDetails";
import OccupationDetails from "../proposal/components/OccupationDetails";
import {
	type AddProposalDTO,
	AddProposalSchema,
	emptyProposal,
} from "./policySchema";
import ChildDetails from "../policy-endorsement/components/policyTab/ChildDetails";

import BasicDetails from "../policy-endorsement/components/policyTab/BasicDetails";
import RiderList from "../premium-calculator/components/RiderList";
import ExtraDiscounts from "../policy-endorsement/components/policyTab/ExtraDiscounts";
import ProposerBasicDetails from "../policy-endorsement/components/policyTab/ProposerBasicsDetails";
import ProposerBuildDetails from "../policy-endorsement/components/policyTab/ProposerBuildsDetails";
import ProposerMedicalDetails from "../policy-endorsement/components/policyTab/ProposerMedicalDetails";
import ProposerLabTestDetails from "../policy-endorsement/components/policyTab/ProposalLabTestDetails";
// import ProposerDoctorDetails from "./policyTab/ProposerDoctorsDetails";
import ProposerConstultantDoctorDetails from "../policy-endorsement/components/policyTab/ProposerConsultantsDoctotsDetails";
import ProposerDoctorDetails from "../proposal/components/ProposerDoctorDetails";


export default function ProposalForm({ data }) {
			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit, onInvalid)}>
					...
					/>
						...
						<ProposerBasicDetails
							proposalRequiredFields={proposalRequiredFields}
							form={form}
						/>
						<ProposerBuildDetails
						form={form}
						/>
						<ProposerMedicalDetails 
						form={form} />
						<ProposerLabTestDetails 
						form={form} />
						<ProposerDoctorDetails form={form} />
						{/* <ProposerDoctorDetails
							form={form}
						/> */}
						<ProposerConstultantDoctorDetails
							form={form}
						/>
