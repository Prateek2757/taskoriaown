const Policy8 = ({ policyBond }: { policyBond: any }) => {
      ...
      <div className="border border-gray-800 mb-6">
        <table className="w-full ">
          <tbody>
            ...
            <tr className="border-b border-gray-800">
              <td rowSpan={9} className="border-r border-gray-800 p-2">
                <b>
                ...
                <br />
                <br />
                <b>ठेगाना : </b> {policyBond?.insuredAddressLocal} <br />
                <br />
                <br />
                <b>इच्‍छाएको व्यक्तिको माता/पिता को नाम : </b>{" "}
                {policyBond?.nomineeName}
                <br /> <br />
                <b>बीिमत र इच्‍छाएको व्यक्तिको बीचको नाता :</b>{" "}
            ...
            <tr className="border-b border-gray-800">
              <td className="p-2">
                <b> प्रथम बीमाशुल्क भुक्तानी मिति : </b>{" "}
                {policyBond?.finalPayDate}
              </td>
            </tr>
            <tr className="border-b border-gray-800">
              <td className="p-2">
                <b> रिसद न: </b> {policyBond?.finalPayDate}
              </td>
            </tr>
            ...
            <tr className="border-b border-gray-800">
              <td className="p-2">
                <b>बीमितको जन्म मिति : </b> {policyBond?.dateOfBirth} <br />
            ...
            <tr>
              <td className="border-r border-gray-800 p-2">
                <b>संलग्न पूरक करारको क्रमाङ्क: </b>{" "}
                {policyBond?.riderNumberLocal}
              </td>
            </tr>
          </tbody>
        </table>
