const Policy14 = ({ policyBond }: { policyBond: any }) => {
          ...
          <tbody>
            <tr className="border-b border-gray-800">
              <td rowSpan={2} className="border-r border-gray-800 p-2">
                <b>बीमालेख कार्यालय 1 :</b> {policyBond?.branchNameLocal}
              </td>
              <td className="p-2">
            ...
            <tr>
              ...
              <td className="p-2">
                <b>संलन पूरक करारः : </b> {policyBond?.riderNumberLocal}
              </td>
            </tr>
          </tbody>
        </table>
