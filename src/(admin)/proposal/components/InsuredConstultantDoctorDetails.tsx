...
interface InsuredConstultantDoctorDetailsProps {
	form: UseFormReturn<AddProposalDTO>;
}
export default function InsuredConstultantDoctorDetails({
	form,
}: InsuredConstultantDoctorDetailsProps) {
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle> Insurer Consultant Doctor's Detail</CardTitle>
			</CardHeader>
			<CardContent>
