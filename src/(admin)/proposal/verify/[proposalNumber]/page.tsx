"use client";
import { Check, Loader2Icon, Printer } from "lucide-react";
...
import ProposalVerifyModal from "../../components/ProposalVerfiyModal";
                    ...
                    >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style={cellStyle}>
                              ...
                              {proposalData.insuredDetails.dateOfBirthLocal}{" "}
                              (Age :{proposalData.insuredDetails.age} Yrs.)
                            </td>
                            ...
                            <td style={cellStyle}>
                              {proposalData.proposerRelationship}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style={cellStyle}>
                              ...
                              {proposalData.insuredMedical.height} ft.) /
                              {proposalData.insuredMedical.weight}
                            </td>
                      ...
                      >
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style={cellStyle}>
                              {proposalData.insuredDetails.occupation}
                            </td>

                            <td style={cellStyle}>
                              {proposalData.insuredDetails.occupationExtraId}
                            </td>
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            <td style={cellStyle}>
                              Dirghayu Bachat Laghu Beema Yojana
                            </td>
                            <td style={cellStyle}>395,000.00</td>
                            <td style={cellStyle}>16</td>
                            <td style={cellStyle}>9</td>
                            <td style={cellStyle}>133.32</td>
                            <td style={cellStyle}>Yearly</td>
                            <td style={cellStyle}>52,661.00</td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      >
                        <thead>
                          <tr>
                            <th style={thStyle}>Nominee Name</th>
                            <th style={thStyle}>Nominee Address</th>
                            <th style={thStyle}>Nominee Father Name</th>
                            <th style={thStyle}>Nominee Relation</th>
                          </tr>
                        </thead>
                        <tbody>
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td style={cellStyle}>
                              {proposalData.tablePremium}
                            </td>
                          </tr>
                          <tr>
                            <td style={cellStyle}>Discount Rate</td>
                            <td style={cellStyle}>
                              {proposalData.discountRate}
                            </td>
                            <td style={cellStyle}>
                      ...
                      >
                        <tr>
                          <td>
                            <b>Gross Premium :</b> 50,028.00 &nbsp;&nbsp;
                          </td>
                          <td>
                            <b>Less Medical :</b> 00.00 &nbsp;&nbsp;
                          </td>
                          <td>
