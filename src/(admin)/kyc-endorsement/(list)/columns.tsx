  ...
  return (
    <div className="flex gap-1">
      ...
      <Button
        ...
        size="icon"
        onClick={() =>
          router.push(`/kyc-endorsement/view/${kycRow.endorsementIdEncrypted}`)
        }
        title="View"
      >
        <Eye />
      ...
      {kycRow.status !== "VERIFIED" && (
        <Button
          ...
          onClick={() =>
            router.push(
              `/kyc-endorsement/edit/${kycRow.endorsementIdEncrypted}`
            )
          }
          title="Edit"
        >
      ...
      <Button
        ...
        onClick={() =>
          router.push(
            `/kyc-endorsement/verify/${kycRow.endorsementIdEncrypted}?KYCNumberEncrypted=${kycRow.kycNumberEncrypted}`
          )
        }
        title="Verify"
      >
