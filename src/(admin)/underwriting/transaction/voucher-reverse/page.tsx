...
import {
  EmptyVoucherReverseSchema,
  VoucherReverseDTO,
  VoucherReverseSchema,
} from "./VoucherReverseFPRP";
...
export default function InsurancePremiumUI() {
  ...
  const form = useForm({
    resolver: zodResolver(VoucherReverseSchema),
    defaultValues: EmptyVoucherReverseSchema(),
    mode: "all",
  });

  const onSubmit: SubmitHandler<VoucherReverseDTO> = async (
    formData: VoucherReverseDTO
  ) => {
