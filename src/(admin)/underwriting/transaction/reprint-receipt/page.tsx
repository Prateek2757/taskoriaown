...
import { EmptyReprintReceiptSchema, ReprintReceiptDTO, ReprintReceiptSchema } from "./ReprintSchema";
...
export default function InsurancePremiumUI() {
  ...
  const form = useForm({
    resolver: zodResolver(ReprintReceiptSchema),
    defaultValues: EmptyReprintReceiptSchema(),
    mode: "all",
  });
  

  const onSubmit: SubmitHandler<ReprintReceiptDTO> = async (
    formData: ReprintReceiptDTO
  ) => {
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="mb-6 grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <FormInput name="InstallmentNumber" label="Installment Number" form={form} required={true} type={"number"} />
              </div>
               <Button
                      type="submit"
