...
import { EmptyPolicyPrintSchema, PolicyPrintDTO, PolicyPrintSchema } from "./PolicyPrintSchema";
...
export default function InsurancePremiumUI() {
  ...
  const form = useForm({
    resolver: zodResolver(PolicyPrintSchema),
    defaultValues: EmptyPolicyPrintSchema(),
    mode: "all",
  });
  

  const onSubmit: SubmitHandler<PolicyPrintDTO> = async (
    formData: PolicyPrintDTO
  ) => {
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="mb-6 grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <FormSelect name="type" label="Type" form={form} required={true} options={[]} />
              </div>
               <Button
                      type="submit"
