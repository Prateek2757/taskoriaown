...
import AddLeadModal from "@/components/AddLeads";
      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="space-y-1 text-center sm:text-left">
            <h1 className="text-4xl font-extrabold bg-gradient-to-r from-[#00E5FF]  via-[#6C63FF] to-[#8A2BE2] bg-clip-text text-transparent tracking-tight">
              Your Requests
            </h1>
          ...
          <Button
            ...
            className="bg-gradient-to-r from-[#00E5FF]  via-[#6C63FF] to-[#8A2BE2] hover:from-blue-700 hover:to-green-700 text-white font-medium shadow-lg hover:shadow-xl transition-all flex items-center gap-2 rounded-xl"
          >
          ...
          <Card className="mb-16 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm hover:shadow-md transition-all bg-white/80 dark:bg-gray-900/70 backdrop-blur-sm">
            <CardContent className="py-16 text-center space-y-6 max-w-2xl mx-auto">
              <h2 className="text-2xl font-bold text-foreground">
                ...
                <span className="text-transparent bg-gradient-to-r from-[#00E5FF]  via-[#6C63FF] to-[#8A2BE2] bg-clip-text">
                  Taskoria
                </span>
              </h2>
              ...
              <Button
                onClick={() => setOpenModal(true)}
                className="bg-gradient-to-r from-[#00E5FF]  via-[#6C63FF] to-[#8A2BE2] hover:from-blue-700 hover:to-green-700 text-white font-medium shadow-md hover:shadow-lg transition-all rounded-xl mt-4"
              >
                Get Started
              </Button>
            </CardContent>
