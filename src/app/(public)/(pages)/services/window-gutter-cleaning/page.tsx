// AUTO-GENERATED — Taskoria service page for Window & Gutter Cleaning
import Script from "next/script";

export const metadata = {
  title: "Window & Gutter Cleaning | Taskoria",
  description: "Exterior window and roof gutter cleaning. Long-form information, pricing guidance, FAQs, and booking steps.",
  alternates: { canonical: "/services/window-gutter-cleaning" },
  openGraph: {
    title: "Window & Gutter Cleaning | Taskoria",
    description: "Exterior window and roof gutter cleaning — Compare quotes from vetted professionals and book online.",
    url: "https://www.taskoria.com/services/window-gutter-cleaning",
    siteName: "Taskoria",
    images: [{ url: "/images/services/window-gutter-cleaning.svg", width: 1600, height: 840, alt: "Window & Gutter Cleaning hero" }],
    locale: "en_AU",
    type: "website",
  },
  robots: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50 text-slate-900">
      <section className="relative">
        <img src="/images/services/window-gutter-cleaning.svg" alt="Window & Gutter Cleaning hero" className="w-full h-[360px] object-cover" />
      ...
      <section className="mx-auto max-w-6xl px-6 py-12 grid gap-8">
        <article className="prose prose-slate max-w-none">
          ...
          <p>Window & Gutter Cleaning with Taskoria connects you to vetted professionals who deliver reliable results with minimal hassle. Exterior window and roof gutter cleaning. Our marketplace makes it simple to compare profiles, ratings, and transparent quotes before you book, so you can choose the provider that best fits your timeline and budget.</p>
          <p>Our window & gutter cleaning providers cover a wide spectrum of tasks. Typical work includes scoping, preparation, professional execution, and detailed quality checks at handover. Whether you need a one‑off job, a recurring engagement, or a complex multi‑phase project, you’ll find flexible options on Taskoria.</p>
        ...
        <div className="rounded-2xl bg-slate-900 text-white p-6 md:p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h3 className="text-2xl font-semibold">Ready to get window & gutter cleaning done?</h3>
              <p className="opacity-90">Post your job once—receive quotes fast, compare providers, and book with confidence.</p>
            </div>
            <a href="/quote?service=window-gutter-cleaning" className="inline-flex items-center rounded-2xl px-5 py-3 font-semibold bg-white text-slate-900 hover:bg-slate-100">Get free quotes</a>
          </div>
        </div>
      </section>
