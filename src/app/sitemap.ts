...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { url: 'https://taskoria.com/book/*', lastModified: new Date() },
    { url: 'https://taskoria.com/create', lastModified: new Date() },
    { url: 'https://taskoria.com/maps', lastModified: new Date() },
    ...
    { url: 'https://taskoria.com/services/turst-safety', lastModified: new Date() },
  ]
  return [...staticPages]
} 