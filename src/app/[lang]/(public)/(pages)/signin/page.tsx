...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res?.error) setMessage(res.error);
      ...
      setTimeout(() => router.push("/en/provider/dashboard"), 1000);
    }
  };

  // Sign Up as Provider handler
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      ...
      >
        {/* Background glow */}
        <div className="absolute -inset-0.5 bg-gradient-to-tr from-blue-500 to-green-600 rounded-3xl blur-2xl opacity-20"></div>
        ...
        <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 p-10 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 my-2">
            ...
            <div className="flex-1 h-px bg-gradient-to-r from-green-200 to-blue-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full p-3.5 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-600/60 focus:border-transparent transition shadow-sm"
                required
              />
            </div>
            ...
            <motion.button
              ...
              disabled={loading}
              type="submit"
              className={`mt-2 w-full flex items-center justify-center gap-2 p-4 rounded-xl font-semibold text-white shadow-lg transition-all ${
                loading
                  ? "bg-gradient-to-r from-blue-300 to-green-300 cursor-not-allowed"
                  : "bg-gradient-to-r from-blue-500 to-green-600 hover:shadow-xl hover:scale-[1.02]"
              }`}
            >
              {loading ? (
                <>
