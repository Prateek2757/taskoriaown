...
export default function MyServicesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-4 px-6 space-y-6">
      {/* Header */}
      <Link href="/en/provider/dashboard">
        <Button
          variant="ghost"
          size="lg"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-5 border-b">
                  ...
                  <div className="space-y-4 flex-1 overflow-hidden flex flex-col">
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-11 h-12 text-base border-gray-300 focus:border-green-500 focus:ring-green-500"
                      />
                    </div>
                              ...
                              className={`
                                ...
                                ${
                                  isAlreadyAdded
                                    ...
                                    : "bg-white hover:bg-green-50 border border-gray-200 hover:border-green-300 hover:shadow-sm"
                                }
                              `}
                            >
              ...
              {profile.categories.length > 0 ? (
                <div className="flex flex-wrap gap-2">
                  {profile.categories.map((c) => (
                    <Badge
                      key={c.category_id}
                      className="bg-green-100 text-green-800 px-4 py-2 text-sm rounded-full flex items-center gap-2 cursor-pointer hover:bg-red-100 hover:text-red-700 transition-all"
                      onClick={() => {
                        if (!saving) {
                          setPendingRemove({ type: "service", id: c.category_id });
                          setConfirmOpen(true);
                        }
                      }}
                    >
        ...
        {/* Location Card */}
        <Card className="rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 px-6 py-5 border-b">
...
<Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
  <DialogContent className="sm:max-w-md">
    <DialogHeader>
      <DialogTitle className="text-xl font-bold text-red-600">Confirm Removal</DialogTitle>
      <DialogDescription className="text-gray-600">
        Are you sure you want to remove this {pendingRemove.type === "service" ? "service" : "location"} ?
      </DialogDescription>
    </DialogHeader>
