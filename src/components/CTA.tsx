...
function CTA() {
  ...
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div className="absolute bottom-10 right-5 w-48 h-48 bg-purple-400/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
  ...
  <div className="w-full max-w-5xl mx-auto relative z-10">
    <div className="relative rounded-[1.5rem] border border-white/40 bg-gradient-to-br from-white/95 via-white/90 to-white/85 backdrop-blur-lg p-6 sm:p-8 shadow-xl shadow-gray-900/5 overflow-hidden group transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20">
      <div className="absolute inset-0 rounded-[1.5rem] bg-gradient-to-r from-[#00E5FF] via-[#6C63FF] to-[#8A2BE2] opacity-0 group-hover:opacity-20 blur-lg transition-opacity duration-500"></div>
      ...
      <div className="absolute bottom-8 left-8 w-1 h-1 bg-purple-400 rounded-full animate-ping opacity-75" style={{ animationDelay: '0.5s' }}></div>
      <div className="absolute top-1/3 right-5 w-1 h-1 bg-pink-400 rounded-full animate-ping opacity-75" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-4">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 backdrop-blur-sm">
          ...
          <span className="text-xs font-medium text-slate-700">Trusted by 5,000+ users worldwide</span>
        </div>

        <h2 className="text-slate-900 text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight max-w-2xl">
          Ready to Experience the{" "}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00E5FF] via-[#6C63FF] to-[#8A2BE2] animate-gradient">
            Future?
          </span>
        </h2>
        <p className="text-slate-600 text-sm sm:text-base mt-1 max-w-xl leading-relaxed">
          Join thousands of satisfied customers and providers in our AI‑powered, secure marketplace. Start your journey today!
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-4">
          ...
          <Link href="/providers/join">
            <Button className="relative overflow-hidden bg-gradient-to-r from-[#00E5FF] via-[#6C63FF] to-[#8A2BE2] text-white hover:scale-105 border-0 flex items-center gap-2 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-purple-500/50 px-6 py-3 text-sm sm:text-base font-semibold group">
        ...
        {/* Bottom line */}
        <div className="pt-3">
          <div className="h-1 w-16 bg-gradient-to-r from-[#00E5FF] via-[#6C63FF] to-[#8A2BE2] rounded-full shadow-lg shadow-purple-500/50 animate-pulse"></div>
        </div>
      </div>
    </div>
  </div>
