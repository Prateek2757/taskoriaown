import {
  ...
  export const TaskPostedEmail = ({ username, company = "Taskoria", taskTitle, taskLocation }: TaskPostedEmailProps) => (
    <Html>
      <Head><title>Your task has been posted</title></Head>
      <Body style={{ backgroundColor: "#f3f4f6", fontFamily: "Arial, sans-serif", margin: 0, padding: "16px" }}>
        <Container style={{ maxWidth: "600px", margin: "32px auto", backgroundColor: "#ffffff", borderRadius: "8px", padding: "32px", boxShadow: "0 4px 6px rgba(0,0,0,0.1)" }}>
          ...
          <Section style={{ margin: "32px 0", textAlign: "center" }}>
            <Button href="https://www.taskoria.com/customer/dashboard" style={{ backgroundColor: "#2563eb", color: "#ffffff", padding: "12px 32px", fontSize: "16px", fontWeight: "600", textDecoration: "none", borderRadius: "8px", display: "inline-block" }}>
              View Task
            </Button>
          </Section>
