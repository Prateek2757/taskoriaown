import {
          ...
          <Section style={s.brandBar}>
            <Container style={s.brandBarInner}>
              <Row>
                <Column>
                  <Img
                    src={`${baseUrl}/taskorialogonew.png`}
                    alt={company}
                    width="30"
                    height="30"
                ...
                <Column style={{ textAlign: "right" as const }}>
                  <Text style={s.brandTagline}>Connecting pros with customers</Text>
                </Column>
              </Row>
            </Container>
          </Section>
          ...
          <Container style={s.outerContainer}>
            ...
            <Section style={s.heroCard}>
              ...
              <Section style={s.heroBody}>
                ...
                <Row>
                  <Column style={{ width: "52%", paddingRight: "20px", verticalAlign: "top" }}>
                    {/* Credits */}
                    <Row style={{ marginBottom: "18px" }}>
                      ...
                      <Column style={{ verticalAlign: "middle" }}>
                        <Text style={s.infoValue}>{creditsRequired} credits to respond</Text>
                      </Column>
                    </Row>
                  ...
                  <Column style={{ width: "48%", verticalAlign: "top" }}>
                    ...
                    <Section style={s.statsCard}>
                      ...
                      <Row style={{ marginTop: "6px" }}>
                        <Column>
                          <Text style={s.statSubSmall}>{respondedCount} responded</Text>
                        </Column>
                        <Column style={{ textAlign: "right" as const }}>
                          <Text style={isAlmostFull ? s.spotsLeftRed : s.spotsLeftBlue}>
            ...
            <Section style={s.upsellCard}>
              ...
              <Section style={s.upsellBodySection}>
                ...
                <Text style={s.upsellPara}>
                  You'll need credits to contact customers. Our discounted starter pack
                  gives enough credits for about <strong>10 responses</strong> and is
                  backed by our <strong>Get Hired Guarantee.</strong>
                </Text>
                <Text style={s.upsellPara}>
                  If you don't get hired at least once from your starter pack, we'll give
                  you all your credits back.
                </Text>
  
                <Row style={{ margin: "20px 0" }}>
                  <Column style={{ textAlign: "center" as const, paddingRight: "6px" }}>
            ...
            <Section style={s.footer}>
              <Text style={s.footerSmall}>
                Add {company} to your email contacts to ensure all our content goes
              ...
              <Text style={s.footerLinks}>
                ...
                {"  ·  "}
                <Link href={`${baseUrl}/terms-and-conditions`} style={s.footerLink}>
                  Terms of Service
                </Link>
                {"  ·  "}
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    urgencyText: { fontSize: "13px", fontWeight: "700", color: "#92400e", margin: 0 },
    ...
    mapPlaceholderEmoji: { fontSize: "28px", margin: "0 0 6px", textAlign: "center" },
    mapPlaceholderText: {
      fontSize: "13px",
      color: "#1e40af",
      fontWeight: "600",
    ...
    statMain: { fontSize: "13px", fontWeight: "600", color: "#334155", margin: "0 0 2px" },
    ...
    questionText: { fontSize: "14px", fontWeight: "700", color: "#1e293b", margin: "0 0 3px" },
    answerText: { fontSize: "14px", color: "#64748b", margin: 0, lineHeight: "1.5" },
    upsellCard: {
      backgroundColor: "#ffffff",
      marginBottom: "12px",
      overflow: "hidden",
    ...
    footerCopy: { fontSize: "12px", color: "#94a3b8", textAlign: "center", margin: "0 0 8px" },
    footerLinks: { fontSize: "12px", color: "#94a3b8", textAlign: "center", margin: 0 },
