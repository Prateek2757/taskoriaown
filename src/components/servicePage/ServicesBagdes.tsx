...
export function ServicesBadges() {
  ...
  return (
<div className=" items-center divide-x divide-white/20 rounded-2xl   bg-white/15 px-2 py-2 shadow-[0_8px_30px_rgba(0,0,0,0.12)] backdrop-blur-2xl">      {badges.map((badge, idx) => (
