          ...
          {items.map((step, i) => {
            ...
            return (
              ...
              >
                ...
                <button className="mt-auto self-start flex items-center gap-2 text-xs bg-gray-200 text-blue-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-full px-4 py-2 hover:bg-blue-200 dark:hover:bg-slate-700 transition-colors">
                  <Icon
