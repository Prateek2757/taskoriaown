...
export default function CitySpecificContent({
  ...
  return (
    <div className="mb-20">
      <div className="bg-gradient-to-br from-white to-blue-50/50 dark:from-slate-800 dark:to-blue-900/20 rounded-3xl p-8 md:p-10 shadow-lg border border-blue-100 dark:border-blue-800/30">
          ...
          <div className="bg-white/50 dark:bg-slate-700/30 rounded-2xl p-6 border border-gray-200/50 dark:border-slate-600/50">
            ...
            <div className="flex flex-wrap gap-3">
              {cityData.top_services.map((service: string, i: number) => (
                <span
                  key={i}
                  className="px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-sm font-medium hover:bg-blue-200 dark:hover:bg-blue-800/40 transition-colors cursor-default"
                >
                  {service}
                </span>
              ))}
