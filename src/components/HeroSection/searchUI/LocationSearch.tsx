...
export default function LocationSearch({
  ...
  <IoLocationOutline className="absolute left-4 top-3 w-5 h-4 text-gray-500" />
  ...
  <Input
    ...
    className="border py-5 pl-9 pr-9 text-sm shadow-sm focus:outline-none focus:ring-primary"
  />
