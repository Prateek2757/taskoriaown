        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2 flex-wrap">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="w-20 h-7 bg-gray-100 dark:bg-gray-800 rounded-full"
              />
            ))}
          </div>
        </div>
      ...
      <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 bg-[#2563EB]/10 rounded-lg flex items-center justify-center">
            <Wrench className="w-4.5 h-4.5 text-[#2563EB]" />
          </div>
        ...
        <Link href="/settings/leads/myservices">
          <Button
            size="sm"
            variant="outline"
            className="h-8 text-xs font-semibold border-gray-200 bg-[#2563EB] dark:border-gray-700 text-white dark:text-gray-300 hover:bg-[#2563EB] hover:text-white hover:border-[#2563EB] transition-all"
          >
      ...
      <div className="p-5 space-y-6">
        <div>
          ...
          {profile.categories.length ? (
              ...
              {profile.categories.map(
                (c: { category_id: string; category_name: string }) => (
                  <div
                    key={c.category_id}
                    className="
                    bg-[#2563EB]/8 text-[#2563EB] border border-[#2563EB]/20 
                    px-3 py-1 text-xs font-medium rounded-lg
                    hover:bg-[#2563EB]/15 transition-colors cursor-default
                    dark:bg-[#2563EB]/10 dark:text-[#60A5FA] dark:border-[#2563EB]/25
                  "
                  >
                    {c.category_name}
                  </div>
            ...
            <div className="border border-dashed border-gray-200 dark:border-gray-700 rounded-xl p-4 text-center">
              ...
              <Link href="/settings/leads/myservices">
                <span className="text-xs text-[#2563EB] hover:underline cursor-pointer mt-1 inline-block">
                  + Add a service
                </span>
              </Link>
            </div>
        ...
        <div>
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-3 border border-gray-100 dark:border-gray-800 space-y-2">
            {isNationwide ? (
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 bg-[#2563EB]/10 rounded-lg flex items-center justify-center">
              ...
              userLocations.map((loc) => (
                ...
                >
                  ...
                  {loc.radius > 0 ? (
                    <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-[#2563EB]/10 text-[#2563EB] whitespace-nowrap">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-2 leading-relaxed">
            ...
            <Link
              href="/settings/leads/myservices"
