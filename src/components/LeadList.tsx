  ...
  return (
    <div className="space-y-6">
      {filteredLeads.map((lead) => (
        ...
        >
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#2563EB]  via-[#A6B4FA] to-[#46CBEE]"></div>
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="pt-3">
              <Button
                size="sm"
                asChild
                className="w-full bg-gradient-to-r from-[#2563EB]  via-[#A6B4FA] to-[#46CBEE] hover:from-blue-700 hover:to-cyan-700 text-white font-medium rounded-xl shadow-sm hover:shadow-md transition-all"
              >
